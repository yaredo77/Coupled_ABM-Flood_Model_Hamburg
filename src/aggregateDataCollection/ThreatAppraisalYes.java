...
/**
 * This class records the number of households that appraise threat at each time step.
 */
public class ThreatAppraisalYes implements AggregateDataSource{
	@Override
	public String getId() {
		return "Threat Yes (per tick)";
	}
