...
/**
 * This class records the cumulative number of households that implemented primary measures (evaluated at each time step).
 * 
 */
public class PrimaryMeasureImplementedYes implements AggregateDataSource{
	@Override
	public String getId() {
		return "Primary measure implemented Yes (cum)";
	}
	...
	public Object get(Iterable<?> objs, int size) {
		int count = 0;
		for (Object o: objs) {
			if (((House) o).isImplementAdaptationMeasure()) {
				count++;
			}
		}
		return count;
