...
/**
 * This class records the cumulative number of households that abandoned primary measures (evaluated at each time step).
 * 
 */
public class PrimaryMeasureAbandonedYes implements AggregateDataSource{
	@Override
	public String getId() {
		return "Primary measure abandoned Yes (cum)";
	}
	...
	public Object get(Iterable<?> objs, int size) {
		int count = 0;
		for (Object o: objs) {
			if (((House) o).isAbandonPrimaryMeasure()) {
				count++;
			}
		}
		return count;
