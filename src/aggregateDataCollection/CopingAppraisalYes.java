...
/**
 * This class records the cumulative number of households that appraise coping (evaluated at each time step).
 */
public class CopingAppraisalYes implements AggregateDataSource{
	@Override
	public String getId() {
		return "Coping Yes (cum)";
	}
