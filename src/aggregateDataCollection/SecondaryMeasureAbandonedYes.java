...
/**
 * This class records the cumulative number of households that abandoned a secondary measure (evaluated at each time step).
 * 
 */
public class SecondaryMeasureAbandonedYes implements AggregateDataSource{
	@Override
	public String getId() {
		return "Secondary measure abandoned Yes (cum)";
	}
	...
	public Object get(Iterable<?> objs, int size) {
		int count = 0;
		for (Object o: objs) {
			if (((House) o).isAbandonSecondaryMeasure()) {
				count++;
			}
		}
		return count;
